...
export function getEnvConfig(): EnvConfig {
  ...
  const collections = {
    ...
    typing:
      firstDefined(process.env.NEXT_PUBLIC_APPWRITE_TYPING_COLLECTION_ID) ||
      null,
    memberships:
      firstDefined(
  ...
  const teams = {
    adminTeamId:
      firstDefined(
        process.env.NEXT_PUBLIC_APPWRITE_ADMIN_TEAM_ID,
        process.env.APPWRITE_ADMIN_TEAM_ID
      ) || null,
    moderatorTeamId:
      firstDefined(
        process.env.NEXT_PUBLIC_APPWRITE_MODERATOR_TEAM_ID,
