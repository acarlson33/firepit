...
function DropdownMenuItem({
  ...
  const itemClassName = [
    ...
    "data-[variant=destructive]:*:[svg]:text-destructive! [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0",
  ];

  return (
    <DropdownMenuPrimitive.Item
      className={cn(itemClassName.join(" "), className)}
      data-inset={inset}
