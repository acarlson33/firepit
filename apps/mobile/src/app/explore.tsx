          ...
          <ThemedView style={styles.shell}>
            ...
            >
              ...
              <ThemedText themeColor="mutedForeground" style={styles.copy}>
                Firepit-style warm neutrals and compact cards keep the browser
            ...
            >
              ...
              />
              {authError ? (
                <ThemedText themeColor="destructive">{authError}</ThemedText>
              ) : null}
            </ThemedView>
            ...
            >
              ...
              {serverError ? (
                <ThemedText themeColor="destructive">{serverError}</ThemedText>
              ) : null}
              ...
              {signedIn ? (
                myServers.length > 0 ? (
                  ...
                  <ThemedText themeColor="mutedForeground">
                    You have not joined any servers on this instance yet.
                  </ThemedText>
                )
              ) : (
                <ThemedText themeColor="mutedForeground">
            ...
            <ThemedView
              ...
              style={[styles.card, { borderColor: theme.border }]}
            >
              <ThemedText type="smallBold">Public discovery</ThemedText>
              <ThemedText themeColor="mutedForeground" style={styles.copy}>
                Join a public server directly or open it to inspect the
                workspace shell.
              </ThemedText>
              <View style={styles.list}>
                {publicServers.map((server) => (
                  <ServerCard
                    ...
                    onJoin={
                      signedIn && instanceUrl && accessToken && server.$id
                        ? async () => {
                            try {
                              setJoiningServerId(server.$id ?? null);
                              await joinServer(
                                instanceUrl,
                                accessToken,
                                server.$id ?? "",
            ...
            >
              ...
              <ThemedText themeColor="mutedForeground" style={styles.copy}>
                The workspace shell is intentionally narrow so the future
                channel and message timeline can slot in without a redesign.
              </ThemedText>
            </ThemedView>
          </ThemedView>
        </SafeAreaView>
    ...
    >
      <View style={styles.serverCardHeader}>
        <View style={styles.serverTextBlock}>
          ...
          <ThemedText themeColor="mutedForeground" style={styles.serverMeta}>
      ...
      <View style={styles.cardActions}>
        ...
        />
        {onJoin ? (
          <ActionButton label={joinLabel} tone="ghost" onPress={onJoin} />
        ) : null}
      </View>
    </ThemedView>
  );
