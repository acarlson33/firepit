        ...
        <ThemedView style={styles.shell}>
          ...
          >
            ...
            <ThemedText themeColor="mutedForeground" style={styles.description}>
              Use a valid account for the selected Firepit instance. Once you
              sign in, the app sends you to the protected chat flow.
            </ThemedText>
          </ThemedView>
          ...
          >
            ...
            <View style={styles.statusRow}>
              ...
              />
              <StatusPill
                label={instanceUrl ? "instance set" : "instance missing"}
                tone={instanceUrl ? "success" : "warning"}
              />
              <StatusPill
                label={signedIn ? "signed in" : "awaiting credentials"}
